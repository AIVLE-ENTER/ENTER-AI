...
class VectorPipeline():
    ...
    def embedding_and_store(cls, 
        ...
        kwd_db_path = cls.BASE_DIR.parent / user_id / 'database' / f'{keyword}'  
        ...
        if kwd_db_path.is_dir():
            vectorstore_old = FAISS.load_local(kwd_db_path, embedding)
...
if __name__ == "__main__":
    VectorPipeline.delete_store_by_keyword('asdf123', 'cafecopy')